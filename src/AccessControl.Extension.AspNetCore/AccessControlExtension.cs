...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            return services.AddAccessControl(false);
        }
        ...
        {
            return builder.AddResourceAccessStrategy<TResourceAccessStrategy>(ServiceLifetime.Singleton);
        }
        ...
        {
            return builder.AddControlAccessStrategy<TControlAccessStrategy>(ServiceLifetime.Singleton);
        }
